export const AZURE_VMSS_AUTOSCALING_CODE = `kind: ScalingComponent
id: scaling_component_azure_virtual_machine_scale_sets
...
---
kind: ScalingPlan
id: scaling_plan_azure_virtual_machine_scale_sets
title: scaling plan for azure virtual machine scale sets
  cool_down: 0 # seconds
...
plans:
  ...
  - id: scaling_plan_azure_virtual_machine_scale_sets_scale_in_1
    description: scale-in capacity
    # JavaScript expression that returns a boolean value.
    expression: >
      (get({
        metric_id: 'telegraf_prometheus_azure_vmss_metrics',
    ...
    priority: 2
    scaling_components:
      - component_id: scaling_component_azure_virtual_machine_scale_sets
        capacity: 1
  - id: scaling_plan_azure_virtual_machine_scale_sets_scale_in_2
    description: scale-in capacity
    # JavaScript expression that returns a boolean value.
    expression: >
      (get({
    ...
    scaling_components:
      - component_id: scaling_component_azure_virtual_machine_scale_sets
        capacity: 5
  - id: scaling_plan_azure_virtual_machine_scale_sets_scale_out_1
    ...
    scaling_components:
      - component_id: scaling_component_azure_virtual_machine_scale_sets
        capacity: 10
  - id: scaling_plan_azure_virtual_machine_scale_sets_scale_out_2
    description: scale-out capacity
    # JavaScript expression that returns a boolean value.
    expression: >
      (get({
